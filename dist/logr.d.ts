...
declare function l_union_(...objs_labels: any[]): any;
declare function l_LL_(obj: any, x: any): Readonly<{}>;
declare function l_RR_(obj: any, x: any): Readonly<{}>;
declare function l_assert_(actual: Record<string, number>, required: Record<string, number>): boolean;
...
export { LOGR, lRef, create_Referenced_l_ as _create_Referenced_l, l_length_ as l_length, l_array_ as l_array, l_concat_ as l_concat, l_merge_ as l_merge, l_union_ as l_union, l_LL_ as l_LL, l_RR_ as l_RR, l_assert_ as l_assert };
